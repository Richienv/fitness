...
const SYNONYM_GROUPS: string[][] = [
  ...
  ["soup", "soto", "sop", "sup"],
  // café / western / common ordered dishes
  ["smoothie", "smoothies"],
  ["salad", "salads"],
  ["steak", "stik", "stick"],
  ["burger", "hamburger", "hamburg", "hambuger"],
  ["pizza", "piza"],
  ["pasta", "spaghetti", "spageti", "macaroni", "makaroni"],
  ["fries", "french fries", "kentang goreng"],
  ["omelette", "omelet", "telur dadar", "dadar"],
  ["sandwich", "roti isi", "roti lapis"],
  ["toast", "roti bakar"],
  ["cereal", "cereals", "sereal"],
  ["granola"],
  ["boba", "bubble tea", "pearl", "mutiara"],
  ["matcha"],
  ["smoothie bowl", "acai", "acai bowl"],
  ["dumpling", "dumplings", "pangsit", "wonton", "dimsum", "dim sum"],
  ["spring roll", "lumpia", "risol", "risoles"],
  ["fritter", "bakwan", "bala bala", "ote ote"],
  ["kwetiau", "kuey teow", "kwetiaw", "kuetiau"],
  ["teriyaki"],
  ["katsu", "katssu"],
  ["gyoza"],
  ["ramen"],
  ["sushi"],
  ["crab stick", "kani", "kanikama", "surimi"],
  ["french toast", "roti panggang"],
  ["wrap", "kebab", "kebap", "shawarma"],
  // preparations / states
  ["fried", "goreng"],
